            ...
            while (true) {
                ...
                switch (command) {
                    ...
                    case REQ_CREATEROOM: {
                        ...
                        boolean isRock;
//                        id = st.hasMoreTokens() ? st.nextToken() : "";
//                        String roomInfo = st.hasMoreTokens() ? st.nextToken() : "";
//                        StringTokenizer room = new StringTokenizer(roomInfo, DELIMETER);
//                        roomName = room.hasMoreTokens() ? room.nextToken() : "";
//                        roomMaxUser = room.hasMoreTokens() ? Integer.parseInt(room.nextToken()) : 0;
//                        isRock = (room.hasMoreTokens() ? Integer.parseInt(room.nextToken()) : 0) != 0;
//                        password = room.hasMoreTokens() ? room.nextToken() : "";
